defmodule CGx99 do
  ...
  def main_loop(z, _, _, _, rnorm, zeta, 0, mvtime), do: {z, Nx.to_number(rnorm), Nx.to_number(zeta), mvtime}
  def main_loop(_, shift, a, x, _, _, it, mvtime) do
        {z, rnorm, mvtime} = conjgrad(a, x, mvtime)
        ...
        main_loop(z, shift, a, x, rnorm, zeta, it-1, mvtime)
  end

  def conjgrad(a, x, mvtime) do
      ...
      {z, mvtime} = conjgrad_loop(a, z, r, rho, p, 25, bnorm, mvtime)
  ...
  def conjgrad_loop(_, z, _, _, _, 0, _, mvtime), do: {z, mvtime}

  def conjgrad_loop(a, z, r, rho, p, i, bnorm, mvtime) do
      ...
      conjgrad_loop(a, z, r, rho, p, i - 1, bnorm, mvtime)
  end
